           ...
           <div className="flex flex-row items-center justify-center h-full container mx-auto ">
                ...
                <div className="flex flex-col h-1/2 w-1/2 items-center justify-center gap-6">
                    ...
                    <div className="flex flex-row items-center justify-center h-12 gap-6">
                        <button className="hover:ring-1 ring-white bg-[#ed673b] text-[#ebebeb] font-[Athiti] font-semibold text-lg px-4 py-2 rounded-md">Play with Computer</button>
                        <button className="hover:ring-1 ring-white bg-[#fefafd] text-[#000000] font-[Athiti] font-semibold text-lg px-4 py-2 rounded-md">Play with a Friend</button>
                    </div>
                </div>
